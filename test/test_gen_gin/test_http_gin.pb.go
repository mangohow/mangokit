...
type GreeterHTTPClient interface {
	SayHello(ctx context.Context, req *GreeterRequest, opts ...http.CallOption) (*GreeterResponse, error)
	SayHelloEmptyRequest(ctx context.Context, opts ...http.CallOption) (*GreeterResponse, error)
	SayHelloEmptyResponse(ctx context.Context, req *GreeterRequest, opts ...http.CallOption) error
...
func (c *greeterHTTPClient) SayHello(ctx context.Context, req *GreeterRequest, opts ...http.CallOption) (*GreeterResponse, error) {
	reply := new(GreeterResponse)
	pattern := "/hello/:name"
...
func (c *greeterHTTPClient) SayHelloEmptyRequest(ctx context.Context, opts ...http.CallOption) (*GreeterResponse, error) {
	reply := new(GreeterResponse)
	path := "/hello1"
...
func (c *greeterHTTPClient) SayHelloEmptyResponse(ctx context.Context, req *GreeterRequest, opts ...http.CallOption) error {
	pattern := "/hello2/:name"
	path := http.EncodeURL(pattern, req, false)
...
func (c *greeterHTTPClient) SayHelloEmpty(ctx context.Context, opts ...http.CallOption) error {
	path := "/hello3"
